"""
EfficientNetV2-S — Efficient CNN model for Animal-80 classification.
Now with best-epoch checkpointing, ROC/AUC curves, and normalized
confusion matrix, matching the ResNet50 teammate's methodology.

Run from project root:
    python -m src.models.efficientnet_v2_s
"""
import sys
import time
import json
